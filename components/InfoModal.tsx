  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      >
        ...
        <button
          onClick={onClose}
          className="absolute top-2 right-2 z-10 text-base text-zinc-300 hover:text-[#FF2233] transition-colors leading-none cursor-pointer"
        >
          ✕
        </button>
        ...
        <div className="relative px-5 pt-5 shrink-0 text-center">
          ...
          <div className="text-zinc-500 text-[10px] tracking-widest mb-1">━━━━━━━━━━━━━━━━━━━━━━━━━━</div>
        </div>
